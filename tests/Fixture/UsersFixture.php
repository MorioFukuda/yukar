...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'account_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => 'ユーザのアカウント名', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'account_name' => ['type' => 'unique', 'columns' => ['account_name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'jpa_skill_level' => 1,
            'created' => '2015-11-21 17:49:01',
            'modified' => '2015-11-21 17:49:01'
        ],
    ];
}
